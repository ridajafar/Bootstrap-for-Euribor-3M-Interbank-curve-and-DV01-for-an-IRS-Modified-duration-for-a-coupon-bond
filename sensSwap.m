...
%r=r+1e-4;
%firstRate_factor_DV01 = interp1(dates(2:end), r,fixedLegPaymentDates(2));
%firstDiscountfactor_DV01 = exp(-firstRate_factor_new*yearfrac(fixedLegPaymentDates(1),fixedLegPaymentDates(2),3));
%Discounts_DV01=exp(-r.*yearfrac(dates(1),dates(2:end),3));
%Yearly_Discounts_DV01z=[firstDiscountfactor_DV01; Discounts_DV01(13:17)];

%3rd method: doing the interpolation, the adding the 1e-4
